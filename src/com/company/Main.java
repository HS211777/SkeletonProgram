...
public class Main {
    ...
    public static class SkeletonProgram {
        ...
        public SkeletonProgram() {
            ...
            playerOne = new Player(inputString("What is the name of player one? "));
            playerTwo = new Player(inputString("What is the name of player two? "));
